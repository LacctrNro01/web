...
<html class="no-js" lang="en">
	...
	<body>
		...
		<header id="home" class="welcome-hero">
            ...
            <button id="dark-mode-toggle" class="btn-cart">Modo Nocturno</button>
				                    ...
				                    <li class="dropdown">
				                        ...
				                        <ul class="dropdown-menu cart-list s-cate">
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="{{ asset ('images/collection/arrivals1.png') }}" class="cart-thumb" alt="image" /></a>
				                            ...
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="{{ asset ('images/collection/arrivals2.png') }}" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
				                            ...
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="{{ asset ('images/collection/arrivals3.png') }}" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
						...
						<div class="col-md-3">
							<div class="single-populer-products">
								<div class="single-populer-product-img mt40">
									<img src="{{ asset ('images/populer-products/p1.png') }}" alt="populer-products images">
								</div>
									...
									<div class="row">
										<div class="col-md-4 col-sm-12">
											<div class="single-inner-populer-product-img">
												<img src="{{ asset ('images/populer-products/p2.png') }}" alt="populer-products images">
											</div>
										</div>
							...
							<div class="single-populer-products">
								<div class="single-populer-products">
									<div class="single-populer-product-img">
										<img src="{{ asset ('images/populer-products/p3.png') }}" alt="populer-products images">
									</div>
				...
				<div class="new-arrivals-content">
					<div class="row">
						...
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								<div class="single-new-arrival-bg">
									<img src="{{ asset ('images/collection/arrivals2.png') }}" alt="new-arrivals images">
									<div class="single-new-arrival-bg-overlay"></div>
									<div class="sale bg-2">
										<p>sale</p>
									</div>
						...
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								<div class="single-new-arrival-bg">
									<img src="{{ asset ('images/collection/arrivals3.png') }}" alt="new-arrivals images">
									<div class="single-new-arrival-bg-overlay"></div>
									<div class="new-arrival-cart">
										<p>
											<span class="lnr lnr-cart"></span>
						...
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								<div class="single-new-arrival-bg">
									<img src="{{ asset ('images/collection/arrivals4.png') }}" alt="new-arrivals images">
									<div class="single-new-arrival-bg-overlay"></div>
									<div class="sale bg-1">
										<p>sale</p>
									</div>
						...
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								<div class="single-new-arrival-bg">
									<img src="{{ asset ('images/collection/arrivals5.png') }}" alt="new-arrivals images">
									<div class="single-new-arrival-bg-overlay"></div>
									<div class="new-arrival-cart">
										<p>
											<span class="lnr lnr-cart"></span>
						...
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								<div class="single-new-arrival-bg">
									<img src="{{ asset ('images/collection/arrivals6.png') }}" alt="new-arrivals images">
									<div class="single-new-arrival-bg-overlay"></div>
									<div class="sale bg-1">
										<p>sale</p>
									</div>
						...
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								<div class="single-new-arrival-bg">
									<img src="{{ asset ('images/collection/arrivals7.png') }}" alt="new-arrivals images">
									<div class="single-new-arrival-bg-overlay"></div>
									<div class="sale bg-2">
										<p>sale</p>
									</div>
						...
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								<div class="single-new-arrival-bg">
									<img src="{{ asset ('images/collection/arrivals8.png') }}" alt="new-arrivals images">
									<div class="single-new-arrival-bg-overlay"></div>
									<div class="new-arrival-cart">
										<p>
											<span class="lnr lnr-cart"></span>
        ...
        <!--Change mode-->
        <script src="{{ asset ('js/changemode.js') }}"></script>
    </body>
